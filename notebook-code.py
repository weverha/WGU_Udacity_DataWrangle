...
OSMFILE = "WPM.osm"  #the code does not work without this redundancy...
...
# <p>The following code helps to fix instances where two words that are put together should become seperated with an _, instances where a cuisine type is presented but the word restauarant is not, and instances where amenity descriptions need to be seperated for further refinement like a type and name.</p>
...
# I didn't find errors so I made some up for the sake of explaination and demonstration of code use
amenity_mapping = {
                    "fastfood": "fast_food", 
...
# how do i get rid of this code block and still show the table?
...
# 
# Another thing that doesn't match up, if you look back at most common amenities, it shows many more places to eat than what shows up in the pie chart. This tells me that not all cuisines are being recorded...
